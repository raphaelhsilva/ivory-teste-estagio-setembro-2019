...
namespace ProgramaDeEstagioIvory
{
    class Program
    {
        ...
        {
            string name; //Armazena a entrada do usuário
            string[,] m; //Matriz que armazena os dados para exibir
            char[] splitName = new char[1]; //Armazena os caracteres separados da entrada do usuário
            ...
            Console.WriteLine(); //Linha para organização da exibição
            ...
            for (int i = 0; i < 3; i++)
            {
                ...
                for (int o = 0; o < name.Length + 3; o++)
                {
                    ...
                    if (i == 1 && o <= name.Length - 1)
                    {
                        ...
                        {
                            a++;
                            Console.Write(m[i, o] = splitName[a].ToString() + "\t");
                        }
                        ...
                        Console.WriteLine();
                        int n3 = (name.Length + 2) * 2 + 2;

                        for (int y = 0; y < name.Length + 2; y++)
                        {
                            n3--;
                            n2 = Convert.ToString(n3);
                            Console.Write(m[i, o] = n2 + "\t");
                        }
                        break;
                    }
